...
class EmployeeAdapter (private val employees: MutableList<Employee>, private val context: Context, private val employeeViewModel: EmployeeViewModel, private val storeId: String)
